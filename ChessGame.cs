    ...
    public class ChessGame
    {
        ...
        public ChessGame()
        {
            ...
            Board = new Pieces.Piece?[8, 8]
            {
                ...
                { new Pieces.King(new Point(4, 0), true), new Pieces.Pawn(new Point(4, 1), true), null, null, null, null, new Pieces.Pawn(new Point(4, 6), false), new Pieces.King(new Point(4, 7), false) },
